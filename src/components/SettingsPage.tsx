      ...
      <div className="space-y-6">
        <div className="bg-white rounded-lg shadow p-5 border border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Field
              label="Tarifa Enel (R$/kWh)"
              hint="Tarifa cheia da Enel, incluindo impostos por kWh"
              value={settings.enelTariff}
              step="0.01"
              onChange={(v) => update({ enelTariff: parseFloat(v) || 0 })}
            />
            <Field
              label="Taxa de distribuicao (R$/kWh)"
              hint="Taxa nao compensada cobrada pela Enel por kWh"
